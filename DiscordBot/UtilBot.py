...
async def on_guild_join(guild):
    ...
    settings[str(guild.id)] = {"slurs":Slurs, "swearwords":SwearWords}
...
async def profanitysettings(ctx, Slurs, SwearWords):
    ...
    idle_embed.add_field(name="Syntax:", value="U!profanitysettings [True/False value for slur checks] [True/False value for swear checks]")
    idle_embed.add_field(name="Example:", value="U!profanitysettings True False")
    idle_embed.add_field(name="Notes:", value="The base values for this are Slurs=True and SwearWords=False.")



    if Slurs.lower() == "true" or Slurs.lower() == "false":
        pass
    elif SwearWords.lower() == "true" or Slurs.lower() == "false":
        pass
    else:
    ...
    response.add_field(name="Swear Words", value=SwearWords.upper())
